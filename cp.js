 ...
 */
(function(window, document = this.shadowRoot, undefined) {
    ...
    function ColorPicker(slideElement, pickerElement, callback) {
        ...
        if (!callback) {
            ...
            var slideIndicator = element.querySelector('.slide-indicator');
            var pickerIndicator = element.querySelector('.picker-indicator');
